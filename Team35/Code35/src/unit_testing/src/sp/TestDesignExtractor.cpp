...
TEST_CASE("DE can extract assign pattern correctly", "[Design Extractor]") {
    SECTION("DE can extract correct pattern: x = 3") {
        std::unique_ptr<ASTNode> root =
            std::make_unique<ASTNode>(ASTNode::SyntaxType::Program, std::nullopt);
        std::unique_ptr<ASTNode> proc =
            std::make_unique<ASTNode>(ASTNode::SyntaxType::Procedure, std::nullopt);
        std::unique_ptr<ASTNode> stmtLst =
            std::make_unique<ASTNode>(ASTNode::SyntaxType::StmtLst, std::nullopt);
        std::unique_ptr<ASTNode> assign =
            std::make_unique<ASTNode>(ASTNode::SyntaxType::Assign, std::nullopt);
        std::unique_ptr<ASTNode> lVar =
            std::make_unique<ASTNode>(ASTNode::SyntaxType::Variable, "x");
        std::unique_ptr<ASTNode> rConst =
            std::make_unique<ASTNode>(ASTNode::SyntaxType::Constant, "3");
    ...
    SECTION("DE can extract correct pattern: x =  y * 3") {
        ...
        std::unique_ptr<ASTNode> rVar =
            std::make_unique<ASTNode>(ASTNode::SyntaxType::Variable, "y");
        std::unique_ptr<ASTNode> mul =
            std::make_unique<ASTNode>(ASTNode::SyntaxType::Multiply, "*");
        std::unique_ptr<ASTNode> rConst =
            std::make_unique<ASTNode>(ASTNode::SyntaxType::Constant, "3");
    ...
    SECTION("DE can extract correct pattern: x =  1 + y * 3") {
        ...
        std::unique_ptr<ASTNode> rConst1 =
            std::make_unique<ASTNode>(ASTNode::SyntaxType::Constant, "1");
        std::unique_ptr<ASTNode> plus =
            std::make_unique<ASTNode>(ASTNode::SyntaxType::Plus, "+");
