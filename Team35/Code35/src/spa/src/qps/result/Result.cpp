...
//        std::unique_ptr<Result> res = std::make_unique<BoolResult>(r.cols.size() != 0);
//        return std::move(res);
...
//        }
//
//        return std::move(std::make_unique<TableResult>(resultTableHeaders, cols));
//    }
//}
